              ...
              {caseSummary ? (
                <div className="space-y-4">
                  ...
                  <div className="mt-6 pt-4 border-t border-stone-200 space-y-3">
                    ...
                    {/* Model info + cost. Token/cost figures belong to the raw
                        summary generation, so hide them when a structured brief
                        (a separate generation) is displayed instead. */}
                    <div className="flex items-center justify-between text-xs">
                      <div className="flex items-center gap-4 text-stone-600">
                        <span>🤖 Generated by {((activeStructuredCandidate ? activeStructuredCandidate.model : caseSummary.model) || 'Claude').replace(/\s*\(sunday-batch\)$/, '')}</span>
                        {!activeStructuredCandidate && caseSummary.tokens_used && (
