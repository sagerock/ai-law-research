    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-8 px-4">
        <div className="container mx-auto max-w-3xl">
          <Link href="/statutes" className="inline-flex items-center text-sm text-stone-500 hover:text-stone-700 mb-4">
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-6 sm:p-8">
            ...
            {/* Main text */}
            {content.text && (
              <p className="text-stone-800 leading-relaxed mb-4 whitespace-pre-line">{content.text}</p>
            )}
