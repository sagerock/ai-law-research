...
import { Scale, BookOpen, Search, Heart } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <nav className="flex items-center space-x-4 sm:space-x-6">
              <Link href="/" className="text-neutral-600 hover:text-neutral-900 transition flex items-center">
                <Search className="h-5 w-5 sm:mr-2" />
                <span className="hidden sm:inline">Full Search</span>
              </Link>
            ...
            <>
              ...
              {filtered.length === 0 && query ? (
                <div className="text-center py-12">
                  <p className="text-neutral-500 text-lg">No cases match "{query}"</p>
